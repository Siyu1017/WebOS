(function () {
    var yt = new App(null, "", {
        ...
        icon: "https://yt-dler.vercel.app/favicon.ico",
        showloading: true,
...
<path d="M19 5v3.111c0 .491-.398.889-.889.889H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    (() => {
        ...
        function loadPage() {
            ...
            fetch("https://yt-dler.vercel.app" + history[currentHistory]).then(res => {
                return res.text();
            }).then(res => {
                var title = "https://yt-dler.vercel.app" + history[currentHistory];
                ...
                console.log(err);
                browseWindow.changeTitle("https://yt-dler.vercel.app" + history[currentHistory]);
            })
            path.value = history[currentHistory];
            frame.src = "https://yt-dler.vercel.app" + history[currentHistory];
            frame.onload = () => {
