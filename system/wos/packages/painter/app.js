(() => {
    ...
    w_app.loadStyles("./system/wos/packages/painter/app.css", "url", () => {
        w_app.hideLoading();
        app.elements.window.querySelector(".window-frame-application-toolbar-title").innerHTML += `<div class="top"><div class="action-bar unloaded" id="actions"><div class="action" data-action="file"><div class="action-title">檔案</div><div class="action-popup" action-popup="file"><div class="item" disabled="disabled"><div class="command-name">開啟 ( 未完成 )</div><div class="command-key">Ctrl+O</div></div><div class="separation-line"></div><div class="item" disabled="disabled"><div class="command-name">儲存 ( 未完成 )</div><div class="command-key">Ctrl+S</div></div><div class="item" id="download"><div class="command-name">下載</div><div class="command-key">Ctrl+Shift+S</div></div></div></div><div class="action" data-action="edit"><div class="action-title">編輯</div><div class="action-popup" action-popup="edit"><div class="item" disabled="disabled" id="undo"><div class="command-name">復原</div><div class="command-key">Ctrl+Z</div></div><div class="item" disabled="disabled" id="redo"><div class="command-name">取消復原</div><div class="command-key">Ctrl+Y</div></div><div class="separation-line"></div><div class="item" disabled="disabled"><div class="command-name">剪下 ( 未完成 )</div><div class="command-key">Ctrl+X</div></div><div class="item" disabled="disabled"><div class="command-name">複製 ( 未完成 )</div><div class="command-key">Ctrl+C</div></div><div class="item" disabled="disabled"><div class="command-name">貼上 ( 未完成 )</div><div class="command-key">Ctrl+V</div></div></div></div><div class="action" data-action="version"><div class="action-title">自動修正</div><div class="action-popup" action-popup="version" data-select-group-parent="algorithm"><div class="item select" data-select-group="algorithm" data-select-value=""><div class="command-name">關閉</div></div><div class="item select selected" data-select-group="algorithm" data-select-value="DouglasPeucker"><div class="command-name">Douglas-Peucker 算法</div></div><div class="item select" data-select-group="algorithm" data-select-value="RamerDouglasPeucker"><div class="command-name">Ramer-Douglas-Peucker 算法</div></div><div class="item select" data-select-group="algorithm" data-select-value="VisvalingamWhyatt"><div class="command-name">Visvalingam-Whyatt 算法</div></div></div></div></div></div>`;
